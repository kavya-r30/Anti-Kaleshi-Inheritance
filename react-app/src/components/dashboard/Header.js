...
export const Header = () => {
    ...
    return (
        <div className="grid grid-cols-3 gap-6 mb-6">
            <div className="p-6 flex items-center justify-center space-x-4 bg-white hover:shadow-lg transition-shadow shadow-lg rounded-xl">
            <div className="bg-blue-100 p-3 rounded-full">
                <Trophy className="w-6 h-6 text-blue-500" />
            </div>
            <div className='grid grid-cols-3 gap-4 items-center'>
                <div className="text-md text-gray-500 font-semibold">Total Questions</div>
                <div className="text-6xl text-gray-600 col-span-2 text-right" style={{ fontFamily: 'Fairway-medium' }}>{ totalSolved }</div>
            </div>
            </div>
            ...
            <div className='grid grid-cols-3 gap-4 items-center'>
                ...
                <div className="text-6xl text-gray-600 col-span-2 text-right" style={{ fontFamily: 'Fairway-medium' }}>{ totalSubmission }</div>
            </div>
            </div>
            ...
            <div className='grid grid-cols-3 gap-4 items-center'>
                ...
                <div className="text-6xl text-gray-600 col-span-2 text-right" style={{ fontFamily: 'Fairway-medium' }}>{ activeDays }</div>
            </div>
            </div>
        </div>
    );
