  ...
  const platforms = [
    {
      ...
      maxRating: parseInt(data?.leetcode?.contests?.stats?.rating) || 0,
      color: "#FFA116",
      ranking: data?.leetcode?.contests?.stats?.globalRanking?.toLocaleString() || "N/A",
      percentile: "Top " + (data?.leetcode?.contests?.stats?.topPercentage?.toString() || "0") + "%",
    },
    {
      name: "CodeChef",
      currentRating: 1571,
    ...
    },
    {
      ...
      maxRating: data?.codeforces?.profile?.maxRating || 0,
      color: "#1F8ACB",
      ranking: data?.codeforces?.profile?.rank || "N/A",
      percentile: "Entry",
    },
  ];
